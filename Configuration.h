...
#define CUSTOM_MACHINE_NAME "UAV Concordia's EG-Dual"
...
#define HOTEND_OFFSET_Y {0.0, -0.60}  // (in mm) for each extruder, offset of the hotend on the Y axis
...
#define MANUAL_Z_HOME_POS 1 // Distance between the nozzle to printbed after homing
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT 105    // Y point for Z homing when homing all axis (G28).
#endif
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,400,90}  // default steps per unit for EG-Dual
#define DEFAULT_MAX_FEEDRATE          {400, 400, 4, 100}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {1000,3000,60,5000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
...
//KEYPAD SECTION
//
//Settings for Zonestar ADC keypad used on EG-1/EG-Dual
//
#define  ADC_KEYPAD 1
